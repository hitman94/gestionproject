...
/**
 * @author Florian Dao utilis� pour les Users Sp�cifie des m�thodes
...
public class UserDAO extends AbstractDAO<User> {
	...
	/**
	 * Retourne un User correspondant au Username et password transmit en
	 * argument M�thode utilis� en cas de connexion � l'application
	 * 
	 * @param username
	...
	public List<User> usersFromEntreprise(Long id) {
		Query q = em
				.createQuery("SELECT u FROM User AS u WHERE u.entreprise.id=:id");
	...
	public List<User> userWithoutCompanies() {
		TypedQuery<User> q = em.createNamedQuery("findUserWithoutCompany",
				User.class);
