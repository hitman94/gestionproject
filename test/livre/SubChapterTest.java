...
public class SubChapterTest {
	...
	public void testSubChapterConstructor(){
		...
		ChapterInterface subChapter = new SubChapter(new Long("1000"), "SubChapter 1", "SubChapter Author", v, (Chapter) chapter);
	...
	public void testAddParagraph2Times() {
		...
		subChapter.addParagraph(paragraph);
		assertNotEquals(paragraph.getTitle() + " ne peut être ajouté qu'1 fois.", true, subChapter.addParagraph(paragraph));
	}
	...
	public void testRemoveParagraph2Times() {
		...
		assertNotEquals(paragraph.getTitle() + " ne peut être supprimé qu'1 fois.", true, subChapter.removeParagraph(paragraph));
	}
