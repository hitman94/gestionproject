...
public class WorkPackageDAOTest {
	...
	public void deleteWorkPackageUser() {
		...
		assertNull("w2 non null: delete rat�",w2);
	}
	...
	public void updateWorkPackageTest() {
		...
		updateWorkPackage(w);
		WorkPackage w2 = getWorkPackageById("id");
		assertNull("w2 null: update rat�",w2);
		assertEquals("Nom de w2 different de Bob, update rat�","test", w.getVolume("title").getTitle() );
	}
